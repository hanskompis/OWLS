...
\abstract{Semanttisen webin tekniikat tarjoavat uusia mahdollisuuksia web-palveluiden koostamiseen. Kun web-palvelut kuvataan semantiikoin, ne ovat myös koneen ymmärrettävissä. Tällöin voidaan käyttää automaattisia web-agentteja, jotka etsivät palveluita ja hyödyntävät niitä automaattisesti. Yleinen tapa määritellä semantiikoita on OWL -ontologiat. Ontologiat ovat sanastoja merkitysten kuvaamiseen. OWL-S -ontologia  on sanasto web-palveluiden kuvaamiseen. Sen avulla on mahdollista kuvata kuka palvelun tarjoaa, miten palvelu toimii ja kuinka sitä käytännön tasolla käytetään.}
